...
from process_scans import test_img, brighten, boost_contrast
...
img = rgb2gray(test_img[3355:3855, 1020:1390, :])
...
# Yen thresholding
img_eq = brighten(boost_contrast(img))
...
ax_img.set_title('Yen thresholding')
